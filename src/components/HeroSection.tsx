        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full sm:w-auto px-8 py-4 bg-primary text-primary-foreground rounded-full font-semibold text-base shadow-lg hover:shadow-xl hover:bg-primary/90 transition-all glow-effect"
            >
              View Projects
            </motion.a>
            <motion.a
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full sm:w-auto px-8 py-4 bg-secondary text-secondary-foreground rounded-full font-semibold text-base border border-border hover:bg-secondary/80 transition-all"
            >
              Contact Me
            </motion.a>
          </motion.div>
